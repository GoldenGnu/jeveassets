...
import net.nikr.eve.jeveasset.gui.tabs.materials.MateriaExtendedTableFormat;
...
public class TableFormatTest extends TestUtil {
	...
	public void testTableFormatClass() {
		...
		//Secondary Tools
			...
			for (MateriaExtendedTableFormat tableFormat : MateriaExtendedTableFormat.values()) {
				test(tableFormat, tableFormat.getType(), tableFormat.getColumnValue(material));
			}
