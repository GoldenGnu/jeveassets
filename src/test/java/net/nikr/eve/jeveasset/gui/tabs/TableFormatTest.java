...
import net.nikr.eve.jeveasset.gui.tabs.materials.MateriasExtendedTableFormat;
...
public class TableFormatTest extends TestUtil {
	...
	public void testTableFormatClass() {
		...
		//Secondary Tools
			...
			for (MateriasExtendedTableFormat tableFormat : MateriasExtendedTableFormat.values()) {
				test(tableFormat, tableFormat.getType(), tableFormat.getColumnValue(material));
			}
