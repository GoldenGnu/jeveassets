...
public abstract class TabsRattingTracker extends Bundle {

	public static TabsRattingTracker get() {
		return BundleServiceFactory.getBundleService().get(TabsRattingTracker.class);
	}

	public TabsRattingTracker(final Locale locale) {
		super(locale);
	}
