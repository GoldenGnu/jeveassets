...
public enum ColorEntry {
	...
	CONTAINER_LOG_ADDED(ColorEntryGroup.CONTAINER_LOG, DataColors.get().containerLogAdded(), Background.EDITABLE_AND_NOT_NULL, Foreground.NOT_EDITABLE),
	CONTAINER_LOG_REMOVED(ColorEntryGroup.CONTAINER_LOG, DataColors.get().containerLogRemoved(), Background.EDITABLE_AND_NOT_NULL, Foreground.NOT_EDITABLE),
	CONTAINER_LOG_MOVED(ColorEntryGroup.CONTAINER_LOG, DataColors.get().containerLogMoved(), Background.EDITABLE_AND_NOT_NULL, Foreground.NOT_EDITABLE),
	CONTAINER_LOG_MULTIPLE_CHANGES(ColorEntryGroup.CONTAINER_LOG, DataColors.get().containerLogMultipleChanges(), Background.EDITABLE_AND_NOT_NULL, Foreground.NOT_EDITABLE),
	;
