...
public enum ColorEntry {
	...
	CONTAINER_LOG_ADDED(ColorEntryGroup.CONTAINER_LOG, DataColors.get().containerLogAdded(), Colors.LIGHT_GREEN.getColor(), Background.EDITABLE_AND_NOT_NULL, null, Foreground.NOT_EDITABLE),
	CONTAINER_LOG_REMOVED(ColorEntryGroup.CONTAINER_LOG, DataColors.get().containerLogRemoved(), Colors.LIGHT_RED.getColor(), Background.EDITABLE_AND_NOT_NULL, null, Foreground.NOT_EDITABLE),
	CONTAINER_LOG_MOVED(ColorEntryGroup.CONTAINER_LOG, DataColors.get().containerLogMoved(), Colors.LIGHT_BLUE.getColor(), Background.EDITABLE_AND_NOT_NULL, null, Foreground.NOT_EDITABLE),
	CONTAINER_LOG_MULTIPLE_CHANGES(ColorEntryGroup.CONTAINER_LOG, DataColors.get().containerLogMultipleChanges(), Colors.LIGHT_BLUE.getColor(), Background.EDITABLE_AND_NOT_NULL, null, Foreground.NOT_EDITABLE),
	;
