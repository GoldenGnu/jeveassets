...
public class StockpileTab extends JMainTab implements TableMenu<StockpileItem> {
	...
	public class ListenerClass implements ActionListener, ListEventListener<StockpileItem> {
