...
import net.nikr.eve.jeveasset.gui.tabs.log.LogTableFormat;
...
public class TableFormatFactory {
	...
	public static EnumTableFormatAdaptor<LogTableFormat, AssetLogSource> logTableFormat() {
		return new EnumTableFormatAdaptor<>(LogTableFormat.class);
	}
