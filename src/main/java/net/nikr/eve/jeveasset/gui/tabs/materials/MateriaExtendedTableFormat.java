...
public enum MateriaExtendedTableFormat implements EnumTableColumn<Material> {
	...
	private MateriaExtendedTableFormat(final Class<?> type, final Comparator<?> comparator) {
		this.type = type;
