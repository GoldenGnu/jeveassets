...
public class AboutDialog extends JDialogCentered {
	...
	public AboutDialog(final Program program) {
		...
		JEditorPane jProgram = createEditorPane(false,
				...
				+ "Copyright &copy; 2009-2022 Contributors<br>"
				);
		...
		JEditorPane jInfo = createEditorPane(
				...
				+ "&nbsp;<a href=\"https://stop.hammerti.me.uk/api/\">stop.hammerti.me.uk</a> (structure api)<br>"
				+ "&nbsp;<a href=\"https://www.reddit.com/r/evetech/comments/hvltq3/zkill_22k_structures_w_name_and_position\">zKillboard</a> (structure api)<br>"
